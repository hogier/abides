...
class AdaptiveInventoryPOVMarketMakerAgent(TradingAgent):
    """ This class implements a modification of the Chakraborty-Kearns `ladder` market-making strategy, wherein the
        ...
        Also have option to start the `ladder` at the measured spread, the "adaptive option"
    """

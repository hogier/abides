# HERD-5 (Herd Behavior Simulation Configuration):
# - 1     Exchange Agent
...
parser = argparse.ArgumentParser(description='Detailed options for HERD05 config.')
...
kernel = Kernel("HERD05 Kernel", random_state=np.random.RandomState(seed=np.random.randint(low=0, high=2 ** 32,
                                                                                                  dtype='uint64')))
